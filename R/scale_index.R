...
#'
#' @description This function computes the scale index of a signal in the scale interval \eqn{[s_0,s_1]},
...
#'
#' @usage scale_index(signal, scales, powerscales, s1, wname = c("MORLET", "DOG", "PAUL", "HAAR", "HAAR2"), wparam, border_effects = c("BE", "INNER", "PER", "SYM"), makefigure)
#'
#' @param signal A vector containing the signal whose scale indices are wanted. The unit of time is taken as the time difference between two consecutive data.
...
#' @param s1 A vector containing the scales \eqn{s_1}. The scale indices are computed in the intervals \eqn{[s_0,s_1]}, where \eqn{s_0} is the minimum scale.
